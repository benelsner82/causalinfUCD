...
$$testscore_i = \beta_0 + \beta_1 radiation_i +  u_i$$
\vfill
\brf{Radiation exposure is likely not random...}
...
$$testscore_i = \beta_0 + \beta_1 radiation_i + \beta_2 rain_i + \beta_3 alt_i +  \boldsymbol{\delta_s} + u_i$$
\vfill
...
\brf{Higher radiation in 1986} $\Rightarrow$ \brf{lower test scores} in 2011
\vfill
...
$$y_i = \beta_0 + \beta_1 x_i + \boldsymbol{S\gamma} + u_i$$
and include in $\boldsymbol{S}$ **every variable they can find** (everything but the kitchen sink)
