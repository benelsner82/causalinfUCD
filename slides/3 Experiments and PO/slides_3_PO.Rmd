...
```{r, out.width = '60%', echo=FALSE, fig.align="center"}
knitr::include_graphics("trimmed_table.pdf")
```
...
\begin{tabular}{ccccc}
\hline
\textbf{Person} & \textbf{D} & \textbf{PO Treated} $Y^1$ & \textbf{PO Treated} $Y^0$  & \textbf{Causal Effect} \\
\hline
1 & 1 & 80 & 60 & 20 \\
2 & 1 & 75 & 70 & 5 \\
3 & 0 & 70 & 60 & 10 \\
...
In many applications, we want to \brf{estimate the ATT}
\vfill
...
Our estimate of the ATE is contaminates by two biases:
