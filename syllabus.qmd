...
I am available for questions before, during, and after the sessions on Wednesday. I am also happy to chat to you 1:1; please email me.
...
Students should have a firm understanding of basic statistical concepts (descriptive statistics, hypothesis testing), regression analysis, and programming with R or a comparable statistical programming language. There are no strict prerequisites regarding courses: it is possible to take this course without having taken MSc-level econometrics before, as long as students have a good idea of the aforementioned concepts/techniques.
...
In this course, we will use R. What this means is that all the examples are given in R. Using R comes with lots of advantages: it is a very flexible object-oriented programming language with a huge comparative advantage in data analytics. It is free, which is great, and it has excellent AI support through ChatGPT and Github Copilot.
...
Can you use other statistical software packages for the assignments? It depends. I strongly discourage the use of commercial software (STATA, EViews, SPSS). There is simply no need for that. I would approve Python and Julia, but no commercial software or more general languages such as Java or C++. If you use anything else than R, please seek approval before. Also, I cannot provide advice on languages other than R. 
